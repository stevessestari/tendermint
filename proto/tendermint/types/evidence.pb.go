...
func (m *ConflictingHeadersTrace) Reset()         { *m = ConflictingHeadersTrace{} }
func (m *ConflictingHeadersTrace) String() string { return proto.CompactTextString(m) }
func (*ConflictingHeadersTrace) ProtoMessage()    {}
func (*ConflictingHeadersTrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_6825fabc78e0a168, []int{3}
}
func (m *ConflictingHeadersTrace) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConflictingHeadersTrace) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConflictingHeadersTrace.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConflictingHeadersTrace) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConflictingHeadersTrace.Merge(m, src)
}
func (m *ConflictingHeadersTrace) XXX_Size() int {
	return m.Size()
}
func (m *ConflictingHeadersTrace) XXX_DiscardUnknown() {
	xxx_messageInfo_ConflictingHeadersTrace.DiscardUnknown(m)
}

var xxx_messageInfo_ConflictingHeadersTrace proto.InternalMessageInfo

func (m *ConflictingHeadersTrace) GetHeaders() []*SignedHeader {
	if m != nil {
		return m.Headers
	}
	return nil
...
type Evidence_LunaticValidatorEvidence struct {
	LunaticValidatorEvidence *LunaticValidatorEvidence `protobuf:"bytes,2,opt,name=lunatic_validator_evidence,json=lunaticValidatorEvidence,proto3,oneof" json:"lunatic_validator_evidence,omitempty"`
}
type Evidence_PotentialAmnesiaEvidence struct {
	PotentialAmnesiaEvidence *PotentialAmnesiaEvidence `protobuf:"bytes,3,opt,name=potential_amnesia_evidence,json=potentialAmnesiaEvidence,proto3,oneof" json:"potential_amnesia_evidence,omitempty"`
}
type Evidence_AmnesiaEvidence struct {
	AmnesiaEvidence *AmnesiaEvidence `protobuf:"bytes,4,opt,name=amnesia_evidence,json=amnesiaEvidence,proto3,oneof" json:"amnesia_evidence,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*ConflictingHeadersTrace)(nil), "tendermint.types.ConflictingHeadersTrace")
...
var fileDescriptor_6825fabc78e0a168 = []byte{
	...
	,
}
...
func (m *ConflictingHeadersTrace) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConflictingHeadersTrace) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConflictingHeadersTrace) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConflictingHeadersTrace) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConflictingHeadersTrace) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConflictingHeadersTrace: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConflictingHeadersTrace: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
